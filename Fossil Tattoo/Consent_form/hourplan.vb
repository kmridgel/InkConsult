...
Public Class hourplan
    ...
    Private Sub DirSearch()
        ...
        i = 0
        Try
            For Each d In Directory.GetDirectories(strDir3)
    ...
    Private Sub hourplan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If artist = 1 Then
            ...
            strDir3 = "c:\appointment\paullunetta"
            strDir2 = "c:\appointment\paullunetta\your_appointments\"
        End If
        If artist = 2 Then
            strDir = "c:\appointment\jazminwebb\images\"
            strDir3 = "c:\appointment\jazminwebb"
            strDir2 = "c:\appointment\jazminwebb\your_appointments\"
        End If
        If artist = 3 Then
            strDir = "c:\appointment\coltrichardson\images\"
            strDir2 = "c:\appointment\coltrichardson\your_appointments\"
            strDir3 = "c:\appointment\coltrichardson"
        End If
...
yearvar & "|" & monthvar & "|" & calendarlocation & "|" & timeslotbgn & "|" & timeslotend & "|" & reserved)
    ...
    Private Sub writeappoint()
        If My.Computer.FileSystem.DirectoryExists(strDir2) Then
            Dim path As String = strDir2 & saveinfo2(1) & saveinfo2(2) & ".txt"
            Dim writer As New System.IO.StreamWriter(path, True)
            writer.WriteLine(saveinfo2(1) & " " & saveinfo2(2) & " Has confirmed an appointment for " & monthvar & " " & calendarlocation & "," & yearvar & " " & "starting at " _
                             & timeslotbgn & " ending at " & timeslotend & vbCrLf & "the client currently has " & saveinfo2(13) & " tatoos, and had work done approximatly " & vbCrLf & saveinfo2(14) & " ago." _
                             & " The client is going To recieve " & saveinfo2(15) & " in " & saveinfo2(17) & vbCrLf & "approximatly " & saveinfo2(16) & " in size across these locations: " & saveinfo2(19) & "," _
                             & saveinfo2(20) & ", " & saveinfo2(21) & vbCrLf & ", " & saveinfo2(22) & ", " & saveinfo2(23) & ", " & ",and is willing to spend up to " & saveinfo2(18) & vbCrLf & vbCrLf &
                             "Clients Address and Contact Information" & vbCrLf & "---------------------------------------" & vbCrLf &
                             saveinfo2(6) & vbCrLf & saveinfo2(7) & ", " & saveinfo2(8) & vbCrLf & saveinfo2(9) & vbCrLf &
                             "Home Phone: " & saveinfo2(10) & vbCrLf & "Work Phone: " & saveinfo2(11) & vbCrLf & "Email Address: " & saveinfo2(12))
